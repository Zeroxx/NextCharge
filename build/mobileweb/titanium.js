...
var require = {
	app: {
		analytics: true,
		copyright: "2014 by Jasper",
		deployType: "development",
		description: "",
		guid: "d665c38c-3d82-498d-aac2-d1119ffa0189",
		id: "com.cmd.nextcharge",
		name: "Next-Charge",
		names: {},
		publisher: "Jasper",
		url: "http://",
...
d.response||{};d.meta&&"ok"==d.meta.status?(c.success=!0,c.error=!1,c.meta=d.meta,k.debug&&Ti.API.info(JSON.stringify(c))):(c.success=!1,c.error=!0,c.code=d.meta?d.meta.code:d.statusCode,c.message=d.meta?d.meta.message:d.message||d.statusText,k.debug&&Ti.API.error(c.code+": "+c.message));a(c)}})}function i(){p.call(this,2==arguments.length?arguments[0]:{},2==arguments.length?arguments[1]:arguments[0])}function x(b){p.call(this,{},b)}function w(b){b.restNamespace||(b.restNamespace=b.property.toLowerCase());
...
function v(b,a){b[a>>5]|=128<<24-a%32;b[(a+64>>9<<4)+15]=a;for(var d=Array(80),c=1732584193,h=-271733879,f=-1732584194,e=271733878,l=-1009589776,j=0;j<b.length;j+=16){for(var g=c,i=h,s=f,k=e,o=l,m=0;80>m;m++){d[m]=16>m?b[j+m]:(d[m-3]^d[m-8]^d[m-14]^d[m-16])<<1|(d[m-3]^d[m-8]^d[m-14]^d[m-16])>>>31;var n=c<<5|c>>>27,p;p=20>m?h&f|~h&e:40>m?h^f^e:60>m?h&f|h&e|f&e:h^f^e;n=q(q(n,p),q(q(l,d[m]),20>m?1518500249:40>m?1859775393:60>m?-1894007588:-899497514));l=e;e=f;f=h<<30|h>>>2;h=c;c=n}c=q(c,g);h=q(h,i);
f=q(f,s);e=q(e,k);l=q(l,o)}return[c,h,f,e,l]}function q(b,a){var d=(b&65535)+(a&65535);return(b>>16)+(a>>16)+(d>>16)<<16|d&65535}function z(b){for(var a=[],d=(1<<n)-1,c=0;c<b.length*n;c+=n)a[c>>5]|=(b.charCodeAt(c/n)&d)<<32-n-c%32;return a}function o(e,a,d,c,h){var f=!1;this.appKey=e;this.oauthKey=a;this.oauthSecret=d;this.apiBaseURL=c?c:b.sdk.url.baseURL;this.authBaseURL=h?h:b.sdk.url.authBaseURL;this.useThreeLegged=function(a){f=a;this.oauthKey||(this.oauthKey=this.appKey)};this.isThreeLegged=function(){return f};
return this}var t={PROPERTY_TYPE_ONLY_LATEST:0,PROPERTY_TYPE_SLASH_COMBINE:1,PROPERTY_TYPE_IGNORE:2};t.build=function a(d,c){var b=c.children||[],f;for(f in b)if(b.hasOwnProperty(f)){var e=b[f],l=e.propertyTypes||c.propertyTypes||{};l.children=t.PROPERTY_TYPE_IGNORE;for(var j in c)if(c.hasOwnProperty(j))switch(l[j]||t.PROPERTY_TYPE_ONLY_LATEST){case t.PROPERTY_TYPE_ONLY_LATEST:e[j]=void 0===e[j]?c[j]:e[j];break;case t.PROPERTY_TYPE_SLASH_COMBINE:var g=[];c[j]&&g.push(c[j]);e[j]&&g.push(e[j]);e[j]=
g.join("/")}e.method&&!e.children?d[e.method]=function(a){return function(){return a.executor.apply(a,arguments)}}(e):e.property&&a(d[e.property]={},e)}};t.build(k,{verb:"GET",executor:p,children:[{method:"hasStoredSession",executor:function(){Ti.API.warn("Cloud.hasStoredSession has been deprecated. Use Cloud.sessionId property");return g.hasStoredSession()}},{method:"retrieveStoredSession",executor:function(){Ti.API.warn("Cloud.retrieveStoredSession has been deprecated. Use Cloud.sessionId property");
...
h])}a.sort(function(a,b){return a[0]<b[0]?-1:a[0]>b[0]?1:0});b=[];for(c=0;c<a.length;++c)b.push(a[c][1]);return e.formEncode(b)}});e.SignatureMethod.registerMethodClass(["PLAINTEXT","PLAINTEXT-Accessor"],e.SignatureMethod.makeSubclass(function(){return this.key}));e.SignatureMethod.registerMethodClass(["HMAC-SHA1","HMAC-SHA1-Accessor"],e.SignatureMethod.makeSubclass(function(a){A="=";var b=this.key,c=z(b);16<c.length&&(c=v(c,b.length*n));for(var e=Array(16),b=Array(16),f=0;16>f;f++)e[f]=c[f]^909522486,
b[f]=c[f]^1549556828;a=v(e.concat(z(a)),512+a.length*n);a=v(b.concat(a),672);c="";for(b=0;b<4*a.length;b+=3){e=(a[b>>2]>>8*(3-b%4)&255)<<16|(a[b+1>>2]>>8*(3-(b+1)%4)&255)<<8|a[b+2>>2]>>8*(3-(b+2)%4)&255;for(f=0;4>f;f++)c=8*b+6*f>32*a.length?c+A:c+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(e>>6*(3-f)&63)}return c}));var A="",n=8;o.prototype.sendRequest=function(a,d,c,h){var f=b.js.sdk.utils.getAuthType(this);if(f==b.constants.unknown)h(b.constants.noAppKeyError);else{var g=
this.apiBaseURL+"/"+b.sdk.url.version+"/"+a,g=f==b.constants.app_key?g+(b.constants.keyParam+this.appKey):g+(b.constants.oauthKeyParam+this.oauthKey);null==c&&(c={});d=d?d.toUpperCase():b.constants.get_method;c[b.constants.suppressCode]="true";if(!this.isThreeLegged()){var l=b.js.sdk.utils.getCookie(b.constants.sessionId);l||(l=this.session_id);l&&(g=-1!=g.indexOf("?")?g+("&"+b.constants.sessionId+"="+l):g+("?"+b.constants.sessionId+"="+l))}if(this.isThreeLegged()){if(!this.accessToken&&(l=this.getSession()))this.accessToken=
l.access_token;this.accessToken&&(c[b.constants.accessToken]=this.accessToken)}l=c;if(Ti.App.analytics){var j=l.analytics||{};j.id=Ti.Platform.createUUID();Ti.Platform.id&&(j.mid=Ti.Platform.id);j.aguid=Ti.App.guid;j.event="cloud."+a.replace(/\//g,".").replace(/\.json/,"");j.deploytype=Ti.App.deployType||"development";j.sid=Ti.App.sessionId;l.ti_analytics=JSON.stringify(j)}c=b.js.sdk.utils.cleanInvalidData(c);if(a=b.js.sdk.utils.getFileObject(c)){try{var i;i=a.toString().match(/TiFilesystemFile/)?
a.read():a;if(!i){h(b.constants.fileLoadError);return}c[b.constants.file]?(delete c[b.constants.file],c[b.constants.file]=i):c[b.constants.photo]&&(delete c[b.constants.photo],c[b.constants.photo]=i)}catch(k){h(b.constants.fileLoadError);return}i={};if(f==b.constants.oauth||f==b.constants.three_legged_oauth)f={method:d,action:g,parameters:[]},b.js.sdk.utils.populateOAuthParameters(f.parameters,this.oauthKey),this.oauthSecret&&e.completeRequest(f,{consumerSecret:this.oauthSecret}),i[b.constants.oauth_header]=
e.getAuthorizationHeader("",f.parameters)}else if(i={},f==b.constants.oauth||f==b.constants.three_legged_oauth){var f={method:d,action:g,parameters:[]},s;for(s in c)c.hasOwnProperty(s)&&f.parameters.push([s,c[s]]);b.js.sdk.utils.populateOAuthParameters(f.parameters,this.oauthKey);this.oauthSecret&&e.completeRequest(f,{consumerSecret:this.oauthSecret});i[b.constants.oauth_header]=e.getAuthorizationHeader("",f.parameters)}b.js.sdk.utils.sendAppceleratorRequest(g,d,c,i,h,this)}};o.prototype.sendAuthRequest=
...
b.js.sdk.utils.setCookie(b.constants.sessionId,c);g.session_id=c}f(a)}}),j=a;if(d.toUpperCase()==b.constants.get_method||d.toUpperCase()==b.constants.delete_method){var n="",r;for(r in c)c.hasOwnProperty(r)&&(n+="&"+r+"="+e.percentEncode(c[r]));0<n.length&&(j=0<a.indexOf("?")?j+n:j+("?"+n.substring(1)),c={})}k.debug&&(Ti.API.info(d+": "+j),Ti.API.info("header: "+JSON.stringify(h)),Ti.API.info("data: "+JSON.stringify(c)));i.open(d,j);"mobileweb"!=Ti.Platform.osname&&i.setRequestHeader("Accept-Encoding",
"gzip,deflate");if(h)for(r in h)h.hasOwnProperty(r)&&i.setRequestHeader(r,h[r]);i.send(c)};b.js.sdk.utils.decodeQS=function(a){var b=decodeURIComponent,c={},a=a.split("&"),e,f;for(e=0;e<a.length;e++)(f=a[e].split("=",2))&&f[0]&&(c[b(f[0])]=b(f[1]));return c};b.js.sdk.utils.guid=function(){return"f"+(1073741824*Math.random()).toString(16).replace(".","")};b.js.sdk.utils.copy=function(a,b,c,e){for(var f in b)if(c||"undefined"===typeof a[f])a[f]=e?e(b[f]):b[f];return a};var g={session:null,fetchSetting:function(a,
...
d){if("mobileweb"===Ti.Platform.osname)alert("Three Legged OAuth is not currently supported on MobileWeb");else if(a.action){var c=b.js.sdk.UIManager.processParams(a,d);c&&b.js.sdk.UIManager.displayModal(c)}else alert('"action" is a required parameter for com.cocoafish.js.sdk.ui().')};return k};
}});
require("Ti/App/Properties", function(p) {
	p.setString("acs-api-key-production","dDiZMAZlTK1MNIjlbdWqClUnqM6h7Cwo");
	p.setString("acs-api-key-development","OjCS9LC5iZqeRVv0xyym4G75IopHdDVd");
